...
- [ ] **PWA: Precache-Cap von 6 MB zurueck auf 5 MB** — Aktueller Export ist ~5.26 MB. Nach Bundle-Optimierung auf <5 MB `JS_SIZE_LIMIT_BYTES` in `scripts/pwa/build-sw.ts` zurueckfahren. Siehe `build-sw.ts` Zeile 40-41. **Plan: Phase 1 (Tasks 1-2) in [PWA Follow-up Slices Plan](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-13-pwa-followups-plan.md).**
