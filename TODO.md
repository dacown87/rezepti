...
- [ ] **Bug-Reporting: Staging-/Production-Smoke nachziehen** — Nach der lokalen Implementierungs- und Test-Verifikation den echten Slice gegen Staging oder Production mit realem Login pruefen: globalen Root-Level-Einstieg, anon/pre-auth Sign-in-CTA statt Fake-Submit, Importfehler-Report mit `lastFailureSnapshot`, `Meine Meldungen`, Admin-Liste/Detail/Statuswechsel sowie die persistierte `bug_reports`-Quelle der Wahrheit inklusive RLS-Verhalten. Referenz: [2026-06-16-bug-reporting-implementation-plan.md](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-16-bug-reporting-implementation-plan.md).
