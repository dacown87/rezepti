...
- [ ] **Login-First Account Gate: authenticated Production-Smoke** — Noch offen ist ein kurzer QA-User-Durchlauf fuer den Resume-Flow nach Login/Signup/Recovery sowie die sichtbare Header-Bug-Report-Aktion im eingeloggten Zustand.
