...
- [ ] **BYOK-Validation-Policy im Admin sichtbar und aenderbar machen** — Im Admin-Bereich die gemeinsame Validation-Policy fuer `/api/v1/keys/validate` und die BYOK-Extraction-Einstiege anzeigen und pflegbar machen, damit die serverseitige Semantik nicht nur in getrennten Codepfaden lebt. Plan: [2026-06-16-byok-rate-limit-admin-plan.md](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-16-byok-rate-limit-admin-plan.md).
