...
3. **Produkt-/Ops-Follow-ups mit klarer Slice-Grenze**
   ...
   - Recipes Sharing/Favorites/Collections: erster Slice ueber **PR #28 gemergt**; Review-Fixes, finaler Remote-CI-Lauf und lokaler 6/6-Web-/PWA-Smoke sind gruen. Die bewusst getrennten Folge-Slices bleiben unter "Aktive Backlog / Watchlist" offen.
...
- [ ] **Supabase Production-Projekt reaktivieren und Migrationen erneut anwenden** — Der Post-Merge-Workflow `Apply Supabase Migrations` (`28754347275`) scheiterte vor dem Link/Push mit `project is paused`. Nach Reaktivierung des Projekts `zdiqtnljdxuhinqzgcnd` den Workflow erneut ausfuehren und die drei `2026062310*`-Migrationen sowie den Production-Read/Write-Pfad verifizieren.
