...
- [~] **Recipes Sharing/Favorites/Collections Slice umsetzen** — Implementierung auf Branch `feature/recipes-sharing-favorites-collections` abgeschlossen (Phasen 1–4: DB-Migrationen, API-Routen, Client-Datenschicht, Mobile-UI). Ausstehend: Review/CI-Lauf, Merge auf `main` und manueller Web-/PWA-Smoke (siehe `docs/sharing-favorites-collections-smoke-runbook.md`). Plan: [2026-06-23-recipes-sharing-favorites-collections-plan.md](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-23-recipes-sharing-favorites-collections-plan.md).
