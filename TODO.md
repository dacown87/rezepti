...
- [ ] **Produkt-/QA-Reste aus `docs/TEST_STATUS.md` entscheiden** — nach Bereinigung bleiben nur echte Restentscheidungen: dedizierte Dictionary-UI ja/nein, gewuenschte Semantik fuer Kurzbegriff-Suche wie `ei -> Ei/Eier`, optionaler PDF-End-to-End-Rendercheck bei PDF-Regressionen.
