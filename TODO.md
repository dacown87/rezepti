...
3. **Produkt-/Ops-Follow-ups mit klarer Slice-Grenze**
   ...
   - Recipes Sharing/Favorites/Collections: erster Slice umgesetzt, **PR #28 offen** — Review-Fixes und lokaler 6/6-Web-/PWA-Smoke sind gruen; offen sind Commit/Push, Remote-CI-Neulauf und Merge (Details unter "Aktive Backlog / Watchlist").
...
- [~] **Recipes Sharing/Favorites/Collections Slice umsetzen** — Implementierung abgeschlossen und als **PR #28** (Branch `feature/recipes-sharing-favorites-collections`) offen. Die bisherige Remote-CI auf `16981db` war komplett gruen (`test`, `supabase-rls-smoke`, `e2e`, `mobile-release-gate`, `performance-audit`). Der erneute Whole-Branch-Review vom 2026-07-05 hat lokal fuenf Punkte geschlossen: echte PWA-Cache-Invalidierung nach Share/Favorite, Verbot gleichgerichteter Scope-Kopien, stabiler leerer Favoritenfilter, vollstaendiges Share-Read-Model und sichtbarkeitskorrekte Collection-Zaehler. Lokal gruen: Root Unit (`591 passed`, `28 skipped`), Mobile (`367 passed`), Root/Mobile/SW-Typechecks, RNTL-Guard, Secret-Scan, Web-Build, RLS-Smoke und DB-Integration (`31/31`). Der isolierte Browser-/PWA-Smoke bestand alle sechs Pfade; Nachweis im Runbook. **Noch offen:** (1) Review-Fixes committen und pushen, (2) Remote-CI fuer den neuen Head komplett gruen abwarten, (3) Merge auf `main` (User-Entscheidung, kein Auto-Merge), (4) nach Merge TODO/CLAUDE.md/Roadmap auf `done` ziehen. Plan: [2026-06-23-recipes-sharing-favorites-collections-plan.md](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-23-recipes-sharing-favorites-collections-plan.md). Runbook: [sharing-favorites-collections-smoke-runbook.md](/home/patrick/Projekte/rezepti/docs/sharing-favorites-collections-smoke-runbook.md).
