...
- [ ] **Recipes Sharing/Favorites/Collections Slice umsetzen** — Gemeinsamer Mehrphasen-Slice fuer Sharing als Kopierfluss, Favorites als systemdefinierte Collection und benannte private bzw. haushaltsbezogene Collections inklusive erster Mobile-/Web-UI. Der Plan ist seit 2026-06-23 per `gstack-autoplan` geschaerft und als umsetzbar freigegeben. Plan: [2026-06-23-recipes-sharing-favorites-collections-plan.md](/home/patrick/Projekte/rezepti/docs/superpowers/plans/2026-06-23-recipes-sharing-favorites-collections-plan.md).
