...
2. **Northflank-Deploy-Hygiene nur noch als kleiner Follow-up**
   - PR #19 ist gemergt; der Remote-Beweis fuer CI, Deploy und Workflow-Hygiene ist erbracht.
   - Offen bleibt im Northflank-Pfad nur noch der getrennte post-deploy Health-Poll statt eines reinen API-`2xx`-Signals.
