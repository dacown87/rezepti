...
const ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Bewertungsfunktion (Sterne)', percent: 100 },
      { label: 'Persönliche Notizen', percent: 100 },
      { label: 'Kommentarfunktion', percent: 0 },
      { label: 'Rezepte via QR-Code teilen', percent: 100 },
    ],
  },
  {
    category: '📄 Export & Druck',
    items: [
      { label: 'Rezeptkarte als PDF', percent: 100 },
    ],
  },
  {
    category: '📱 Mobile',
    items: [
      ...
      { label: 'PWA installierbar', percent: 100 },
